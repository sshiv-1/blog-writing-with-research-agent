...
from typing import Annotated,Sequence, TypedDict,List,Literal,Optional
...
# setting up output schemas

class Task(BaseModel):
    id:int
    title:str
    goal:str = Field(...,description="one sentence about theOne sentence describing what the reader should do/understand")
...
def orchestator_node(state:State)->dict:
...
def worker_node(payload: dict) -> dict:
    ...
    section_md = _extract_text(response.content)
...
g.add_node("orchestrator", orchestator_node)
...
run("Write a blog on synchronous generators in electrical systems")